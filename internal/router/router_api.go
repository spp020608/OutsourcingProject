...
import (
	"Outsourcing/internal/api"
	midware "Outsourcing/internal/router/middleware"
...
func setupApiRouter(r *gin.Engine) {
	...
	{
		userGroup.POST("/sendCode", api.UserApi.SendCode)
	...
	{
		projectGroup.POST("/sendTask", midware.JwtAuthMiddleware(), api.ProjectApi.SendTask)
		projectGroup.POST("/queryTask", api.ProjectApi.QueryTask)
